...
import com.tobiasfried.rasa.model.Ferment;
...
//        }
        ...
        for (int i = 1; i < teaList.getChildCount(); i++) {
            ...
            v.findViewById(R.id.tea_name_autocomplete).setClickable(editing);
            v.findViewById(R.id.tea_picker).setClickable(editing);
            v.findViewById(R.id.tea_amount_picker).setClickable(editing);
            v.findViewById(R.id.remove_button).setVisibility(editing ? View.VISIBLE : View.GONE);
        }

        primaryDate.setClickable(editing);
        secondaryDate.setClickable(editing);
    }
    ...
    private void setupButtons() {
        ...
        teaAddButton.setOnClickListener(v -> {
            ...
            final View tea = inflater.inflate(R.layout.list_item_tea, teaList);
